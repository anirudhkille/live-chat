    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="flex-1">
        <section className="mx-auto flex max-w-3xl flex-col items-center gap-5 px-6 pt-16 pb-4 text-center sm:pt-24">
          ...
          <h1 className="text-foreground text-4xl font-medium tracking-tight text-balance sm:text-6xl">
            Message people you{" "}
        ...
        >
          <div className="mb-10 text-center">
            ...
            <p className="text-muted-foreground mx-auto mt-2 max-w-xl text-sm text-pretty">
          ...
          <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((feature) => (
              ...
              >
                ...
                <h3 className="text-foreground text-base font-medium text-balance">
                  {feature.title}
                </h3>
